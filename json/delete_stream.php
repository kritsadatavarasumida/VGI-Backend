...
while ( $i == 0 ) {
    ...
    if (substr($streamlist,11,4) == "true") {
        ...
        $streamlist = exec('curl --digest -u wadmin:comlab03 -X DELETE --header "Accept:application/json; charset=utf-8" "http://104.199.155.2:8087/v2/servers/_defaultServer_/vhosts/_defaultVHost_/applications/vgi/streamfiles/'.$stream_name.'"');
